...
test("changing a one-to-many relationship A=>B=>A should clean up the record", function() {
  var store = DS.Store.create();
  ...
  store.load(Person, { id: 1, name: "John Doe", kidney_ids: [1, 2] });
  store.load(Person, { id: 2, name: "Jane Doe", kidney_ids: [3]});
  store.load(Kidney, { id: 1, person_id: 1 });
  store.load(Kidney, { id: 2, person_id: 1 });
  store.load(Kidney, { id: 3, person_id: 2 });
...
test("changing a one-to-one relationship A=>B=>A should clean up the record", function() {
  ...
  store.load(Person, { id: 1, name: "John Doe", heart_id: 1 });
  store.load(Person, { id: 2, name: "Jane Doe" });
  store.load(Heart, { id: 1, person_id: 1 });
...
test("getting the association when the data has been loaded", function() {
  ...
  store.loadMany(Person, [1, 2], [{ id: 1, name: "John Doe", address_id: 3 }, { id: 2, name: "Homeless Bob" }]);
  store.loadMany(Address, [2, 3, 4], [{ id: 2, street: "123 Main St" }, { id: 3, street: "456 Side St", person_id: 1 }, { id: 4, street: "789 Through Way" }]);
...
test("changing A=>B=>A should restore the associations", function() {
  ...
  store.load(Person, { id: 1, name: 'tomhuda', heart_id: 1 });
  store.load(Heart, { id: 1, person_id: 1 });
